...
class GradingAgent:
    ...
    def is_healthy(self) -> bool:
        """Check if the grading agent is healthy"""
        return self.is_healthy_flag and self.model is not None
    
    async def grade_answers(self, segmented_regions: List[Dict[str, Any]], answer_key: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Grade student answers using Gemini AI
        """
        grading_results = []
        
        for region_data in segmented_regions:
